...
ProjectHub のネイティブ Android クライアント。Web フロントエンドと同様に、プロジェクト・チケット・Wiki・工数・会社を扱う。BottomNav は**ホーム・プロジェクト・企業・設定の4タブ**（チケット・工数・連絡先・商談・ガント等は各詳細画面や企業一覧の⋮メニューから辿る子画面として提供し、BottomNav 項目数は4つに抑えている）。
