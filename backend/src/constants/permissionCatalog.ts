    ...
    children: [
      { code: 'projects.overview', name: '概要', position: 0 },
      {
        ...
        children: [
          ...
          { code: 'projects.issues.fields.description', name: '説明', resourceType: 'field', position: 5 },
          { code: 'projects.issues.fields.startDateTime', name: '開始日時', resourceType: 'field', position: 6 },
          { code: 'projects.issues.fields.endDateTime', name: '終了日時', resourceType: 'field', position: 7 },
          { code: 'projects.issues.fields.estimatedHours', name: '予定工数', resourceType: 'field', position: 8 },
          { code: 'projects.issues.fields.dueDate', name: '期日', resourceType: 'field', position: 9 },
          { code: 'projects.issues.fields.doneRatio', name: '進捗率', resourceType: 'field', position: 10 },
        ],
      },
